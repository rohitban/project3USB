...
# DVE full session
# Saved on Thu Oct 23 12:47:56 2014
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{214 193} {1640 1035}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 281} {height 567} {dock_state left} {dock_on_new_line true} {child_hier_colhier 204} {child_hier_coltype 107} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 216} {height 567} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1426} {height 176} {dock_state bottom} {dock_on_new_line true}}
