...
# DVE full session
# Saved on Thu Oct 23 12:28:19 2014
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{214 149} {1642 993}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 283} {height 567} {dock_state left} {dock_on_new_line true} {child_hier_colhier 204} {child_hier_coltype 107} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 218} {height 567} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1428} {height 178} {dock_state bottom} {dock_on_new_line true}}
...
gui_list_show_data -id ${Data.1} {rc_nrzi.rcnz_fsm}
...
gui_open_source -id ${Source.1}  -replace -active top /afs/ece.cmu.edu/usr/jaewonch/Private/class/18-341/p3/jared/top.sv
